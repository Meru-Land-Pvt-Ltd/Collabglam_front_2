...
const ModalShell = memo(function ModalShell({
  ...
  return (
    <div
      className={`fixed inset-y-0 right-0 left-0 flex items-center justify-center bg-black/55 p-4 sm:p-5 md:left-[var(--admin-sidebar-width,92px)] md:px-8 lg:px-10 ${zIndexClass}`}
    >
