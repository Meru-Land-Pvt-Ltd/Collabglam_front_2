        ...
        <div className="mx-auto flex w-full max-w-[1600px] flex-col gap-5">
          ...
          >
            ...
            {partialData && (
              <div className="mt-3 rounded-lg border border-amber-200 bg-amber-50 px-4 py-2.5 text-xs font-medium text-amber-700">
                Large dataset ??? analytics based on the first {MAX_FETCH_PAGES * FETCH_LIMIT} records.
              </div>
            )}

            {error && (
              <div className="mt-3 rounded-lg border border-red-200 bg-red-50 px-4 py-2.5 text-xs font-medium text-red-600">
                {error}
              </div>
            )}
          </SectionShell>
          ...
          <Card className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            <div className="flex flex-col gap-2 border-b border-slate-100 px-5 py-4 lg:flex-row lg:items-center lg:justify-between">
              <div><h2 className="text-xl font-bold tracking-tight text-slate-900">Influencer Directory</h2><p className="mt-0.5 text-xs text-slate-400">Searchable creator records with admin actions</p></div>
            </div>
