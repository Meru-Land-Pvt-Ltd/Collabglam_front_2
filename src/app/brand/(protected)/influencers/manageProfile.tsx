...
//         .filter((item) => item?.name || item?.label || item?.title)
...
// const getSocialProfilesObject = (socialProfiles: any) => {
...
// const getProfileByKey = (profiles: any, key: PlatformKey) => {
//     return (
//         profiles?.[key] ||
...
// const getFirstAvailableProfile = (
...
//         influencerId || searchParams.get("influencerId") || searchParams.get("id") || "";
...
//     const firstSocialProfile = getFirstAvailableProfile(
//         instagramProfile,
//         youtubeProfile,
//         tiktokProfile
//     );
...
//             : safeArray(statsByContentType?.all?.statHistory).length > 0
//                 ? safeArray(statsByContentType?.all?.statHistory)
//                 : safeArray(firstSocialProfile?.statHistory || firstSocialProfile?.history);
...
//     const categoryText =
//         safeArray(influencer?.categories).length > 0
//             ? influencer.categories
//                 .map((item: any) => item?.name || item?.title || item)
//                 .filter(Boolean)
//                 .join(", ")
//             : safeArray(influencer?.categoryIds).length > 0
//                 ? influencer.categoryIds.join(", ")
//                 : "-";

//     const contentLanguages =
//         getTopLanguages(
//             modash?.audience?.languages ||
...
//                 []
//             )
//             : safeArray(influencer?.languageIds).length > 0
//                 ? influencer.languageIds.join(", ")
//                 : "-";
...
//                 : safeArray(firstSocialProfile?.recentPosts).length > 0
//                     ? safeArray(firstSocialProfile?.recentPosts)
//                     : safeArray(modash?.popularPosts);

//     const postItems = recentPostsRaw.slice(0, 5);

//     const milestoneRows = deliverables.map((item: any, index) => ({
...
//     const printableContractId =
//         contract?._id || contract?.contractId || "";
...
//             const res = await api.post(
//                 "/contract/viewPdf",
//                 { contractId: printableContractId },
//                 { responseType: "blob" }
//             );
...
//                                             className="my-0 h-[2rem] w-[2.4rem] px-[0.5rem] rounded-[0.55rem] border border-[#1A1A1A] bg-white shadow-none"
//                                         >
...
//                                     <ComboboxContent
//                                         align="end"
//                                         className="w-[13.6875rem] rounded-[0.75rem] bg-white py-[1rem] px-[0.75rem] shadow-[0_8px_32px_rgba(0,0,0,0.13)]"
//                                     >
...
//                                                         <button
//                                                             onClick={handleClick}
//                                                             className="w-full flex items-center gap-[0.5rem] px-[0.5rem] py-[0.5rem] text-[0.875rem] font-medium rounded-[0.5rem] text-[#1A1A1A] hover:bg-[#F5F5F5] transition-colors"
//                                                         >
//                                                             {label === "Move to workspace" ? (
//                                                                 <img
//                                                                     width={16}
...
//                                                                         e.stopPropagation()
//                                                                     }
//                                                                     className="absolute top-0 -left-55 w-[13rem] rounded-[0.75rem] bg-white p-[0.5rem] shadow-[0_8px_32px_rgba(0,0,0,0.13)] z-50 flex flex-col gap-[0.25rem]"
//                                                                 >
...
//                                                                                 setWorkspaceSubmenuOpen(false);
//                                                                             }}
//                                                                             className="w-full flex items-center gap-3 border p-2 rounded-md text-sm font-medium hover:bg-[#F5F5F5] transition-colors"
//                                                                         >
...
//                                 {
//                                     label: "Email",
//                                     value: dash(influencer?.email),
//                                 },
//                                 {
//                                     label: "Phone",
//                                     value: dash(influencer?.phone),
//                                 },
//                                 {
//                                     label: "Country",
//                                     value: dash(
...
//                                 <StatCard
//                                     label="Joined Date"
//                                     value={formatDate(influencer?.createdAt)}
//                                 />
//                             </div>
//                         </div>
//                     </div>
...
//                     {/* Contract Section */}
//                     <div className="px-4 py-5 border-t border-gray-100">
//                         <h2 className="text-[28px] font-semibold text-[#1f1f1f] mb-5">
//                             Contract
//                         </h2>
...
//                                         {printableContractId ? contractFileName : "No contract found"}
//                                     </p>
//                                     <p className="text-[22px] leading-none text-[#a3a3a3] mt-2">
//                                         {printableContractId ? contractSize : "-"}
//                                     </p>
//                                 </div>
//                             </div>
...
//                                 <button
//                                     type="button"
//                                     onClick={() => handleDownloadContract(contractFileName)}
//                                     disabled={contractLoading || !printableContractId}
...
//                                     disabled={contractLoading || !printableContractId}
//                                     className="h-10 px-4 rounded-xl border border-gray-200 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50"
//                                 >
//                                     Download
//                                 </button>
...
import Communication from "./communication-tab";
...
export default function ManageProfile({ influencerId }: ManageProfileProps) {
    ...
    const renderActiveTab = () => {
        ...
        return <Communication view={view} />;
    };
